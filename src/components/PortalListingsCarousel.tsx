        ...
        <div className="relative group px-6 md:px-16">
          ...
          {canScrollLeft && (
            <button
              ...
              aria-label="Ver anteriores com corretora de imóveis - carrossel para comprar em São Paulo"
            >
          ...
          {canScrollRight && (
            <button
              ...
              aria-label="Ver próximos com corretora de imóveis - carrossel no Morumbi, Butantã e Taboão da Serra"
            >
              ...
              >
                ...
                <div className="p-5 md:p-6 flex-1 flex flex-col justify-between">
                  ...
                  <a
                    ...
                    aria-label={`Ver detalhes do ${listing.title} em ${listing.location} por ${listing.price} no ZAP corretora de imóveis - comprar ou alugar`}
                  >
                    <span>Acessar no ZAP corretora de imóveis</span>

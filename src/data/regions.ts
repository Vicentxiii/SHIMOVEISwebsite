...
export const REGIONS: Record<string, RegionData> = {
  butanta: {
    ...
    metaTitle: 'Imóveis à venda no Butantã, SP | Apartamentos e Casas para Comprar e Alugar | Silvia Helena - CRECISP 125743',
    metaDescription: 'Encontre apartamentos, casas e coberturas para comprar e alugar no Butantã, São Paulo. Assessoria exclusiva da corretora Silvia Helena - CRECISP 125743. Agende visita.',
    h1: 'Imóveis à venda no Butantã, São Paulo | Corretora Silvia Helena - CRECISP 125743',
  ...
  'taboao-da-serra': {
    ...
    metaTitle: 'Imóveis à venda em Taboão da Serra, SP | Casas e Apartamentos para Comprar e Alugar | Silvia Helena - CRECISP 125743',
    metaDescription: 'Encontre casas, apartamentos e terrenos para comprar, vender ou alugar em Taboão da Serra, SP, com o melhor custo-benefício da Grande SP. Fale com a corretora Silvia Helena - CRECISP 125743.',
    h1: 'Imóveis à venda em Taboão da Serra, SP | Corretora Silvia Helena - CRECISP 125743',
  ...
  morumbi: {
    ...
    metaTitle: 'Imóveis de Luxo à venda no Morumbi, SP | Casas e Apartamentos | Silvia Helena - CRECISP 125743',
    metaDescription: 'Encontre imóveis de alto padrão para comprar e alugar no Morumbi, São Paulo. Mansões, apartamentos de luxo e coberturas com consultoria premium da corretora Silvia Helena - CRECISP 125743.',
    h1: 'Imóveis de luxo à venda no Morumbi, São Paulo | Corretora Silvia Helena - CRECISP 125743',

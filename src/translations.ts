...
export const DICT = {
  pt: {
    ...
    nav_schedule: 'Falar com a Silvia',
    nav_portfolio: 'Seu Portfólio',
    
    // Hero
    hero_badge: 'CRECI 125743 • 15 anos entre Butantã, Morumbi e Taboão',
    hero_title: 'Silvia Helena',
    hero_subtitle: 'Corretora há 15 anos entre Butantã, Morumbi e Taboão. Te ajudo a comprar, vender ou alugar com calma e segurança.',
    hero_cta: 'Falar com uma corretora de imóveis especialista nas regiões Butantã, Morumbi e Taboão',
    hero_scroll: 'Conheça meu trabalho',
    hero_private_office: 'ATENDIMENTO EM SÃO PAULO • CRECI 125743',
    ...
    about_ach_desc2: 'Avaliação com base em vendas reais da rua e do prédio — não em chute. Assim sua venda não fica parada com a corretora de imóveis.',
    about_ach_title3: 'Sigilo quando precisa',
    about_ach_desc3: 'Se preferir vender sem placa e sem exposição, trabalho off-market com compradores qualificados.',
    about_ach1_title: 'Atendimento direto comigo',
    about_ach1_desc: 'Você fala sempre comigo, não com uma equipe. Visita, negociação e contrato: eu acompanho.',
    about_ach2_title: 'Preço justo, sem ilusão',
    about_ach2_desc: 'Avaliação com base em vendas reais da rua e do prédio — não em chute. Assim sua venda não fica parada com a corretora de imóveis.',
    about_ach3_title: 'Sigilo quando precisa',
    about_ach3_desc: 'Se preferir vender sem placa e sem exposição, trabalho off-market com compradores qualificados.',
    ...
    about_statement_quote: '“Casa boa é aquela que você ainda gosta 5 anos depois.”',
    about_quote_label: 'DECLARAÇÃO DE SILVIA',
    about_quote: '“Casa boa é aquela que você ainda gosta 5 anos depois.”',
    about_founder: 'Fundadora & Assessora Principal',
    about_role: 'Corretora • CRECI 125743 • 15 anos na região',
    header_cta_consultation: 'Fale com a Silvia',
    mobile_menu_title: 'Menu de Navegação',
    mobile_lang_title: 'Selecionar Idioma',
    mobile_menu_favs: 'Seu Portfólio ({0})',
    mobile_menu_contact: 'Falar com a Silvia',
    ...
    // Portfolio Section
    portfolio_badge: 'Seleção da Silvia',
    portfolio_title: 'Apartamentos e casas que vale visitar',
    portfolio_desc: 'De {1} avaliações que já fiz como corretora de imóveis, selecionei {0} que realmente valem seu tempo agora. Fotos reais, preço justo e história da rua.',
    portfolio_empty_title: 'Nenhum resultado com esse filtro por enquanto',
    portfolio_empty_desc: 'Isso acontece — a região muda rápido. Me conta o que você procura (tamanho, rua preferida, valor) que busco também fora do que está anunciado.',
    portfolio_empty_cta: 'Fale com a Silvia sobre o que você procura',
    portfolio_unlisted_badge: 'Fora do portal',
    portfolio_unlisted_title: 'Procurando algo que não está anunciado?',
    ...
    details_contact_inquiry: 'Fale com a corretora Silvia sobre este corretora de imóveis',
    details_contact_placeholder: 'Como gostaria de ser chamado(a)',
    details_message_placeholder: 'Me conta: o que te fez gostar deste corretora de imóveis? Quando gostaria de visitar com a corretora?',
    details_sending: 'Enviando sua mensagem...',
    details_success_title: 'Mensagem recebida!',
    details_success_desc: 'Obrigada pelo contato! Te respondo em até 4 horas úteis, direto no WhatsApp ou e-mail.',
    details_gallery_title: 'Fotos com a corretora de imóveis',
    details_features_title: 'O que a corretora de imóveis destaca aqui',
    details_close: 'Fechar',

    // Favorites Drawer
    fav_title: 'Salvos com sua corretora de imóveis',
    fav_header: 'Salvos ({0})',
    fav_empty: 'Você ainda não salvou nada com a corretora de imóveis.',
    fav_empty_sub: 'Toque no coração do que gostar para comparar depois com a corretora de imóveis.',
    fav_empty_desc: 'É só tocar no coração do que te interessa e falar com a corretora de imóveis.',
    fav_remove: 'Remover',
    fav_examine: 'Examine',
    fav_collective_title: 'Quer falar sobre todos os salvos?',
    fav_collective_desc: 'Envie uma mensagem única sobre os {0} selecionados e te respondo comparando cada um como sua corretora de imóveis.',
    ...
    // Lifestyle Section
    life_badge: 'Como eu escolho',
    life_title: 'Não é só parede e piso. É onde sua rotina vai acontecer.',
    ...
    // Testimonials
    test_badge: 'Quem já comprou e vendeu comigo',
    test_title: 'Histórias reais',

    // Contact Section
    contact_badge: 'Vamos conversar',
    contact_title: 'Me conta o que você está buscando',
    contact_subtitle: 'Quer comprar, vender ou alugar? Escreva do seu jeito. Te respondo pessoalmente em até 2 horas.',
    contact_form_name: 'Como posso te chamar?',
    contact_form_email: 'Seu melhor e-mail',
    contact_form_phone: 'WhatsApp para te responder',
    contact_form_type: 'Como posso te ajudar?',
    contact_type_buy: 'Quero comprar um imóvel',
    contact_type_sell: 'Quero vender meu imóvel',
    contact_type_portfolio: 'Quero alugar ou colocar para alugar',
    contact_type_offmarket: 'Ainda não achei o que procuro — quero ajuda para procurar',
    contact_form_cap: 'Faixa de valor que imagina?',
    contact_form_notes: 'Conta mais sobre o que procura',
    contact_form_notes_placeholder: 'Ex: procuro 2 quartos perto do metrô Butantã até R$ 600 mil, ou quero vender minha casa no Taboão com quintal...',
    contact_form_submit: 'Enviar mensagem para a Silvia',
    contact_submitting: 'Enviando...',
    contact_success_title: 'Mensagem enviada!',
    contact_success_desc: 'Obrigada! Já recebi sua mensagem e te respondo pessoalmente em até 2 horas no WhatsApp ou e-mail.',
    ...
    footer_disclosures: 'Informações',
